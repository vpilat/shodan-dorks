...
`has_screenshot:true IP Webcam` - 53 results
<br>
...
`title:"blue iris remote view"` - 15 results
...
`"Server: EIG Embedded Web Server" "200 Document follows"` - 148,832 results
<br>
...
`http.title:"Nordex Control" "Windows 2000 5.0 x86" "Jetty/3.1 (JSP 1.1; Servlet 2.2; java 1.6.0_14)"` - 20 results

[C4 Max Commercial Vehicle GPS Trackers](https://www.shodan.io/search?query=%5B1m%5B35mWelcome%20on%20console)  
`[1m[35mWelcome on console` - 16 results
<br>
...
`"Server: CarelDataServer" "200 Document follows"` - 7 results
<br>
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 1,368 results

[Android Root Bridges](https://www.shodan.io/search?query=%22Android%20Debug%20Bridge%22%20%22Device%22%20port%3A5555)  
`"Android Debug Bridge" "Device" port:5555` - 946 results
...
`Lantronix password port:30718 -secured` - 525 results
...
`"Set-Cookie: mongo-express=" "200 OK"` - 203 results
...
`title:"OctoPrint" -title:"Login" http.favicon.hash:1307375944` - 8 results
...
`"QuickBooks files OverNetwork" -unix port:445` - 30 results
...
`port:4444 system32` - 1,207 results
...
`http.title:"dashboard"` - 306,077 results
...
*last updated at: 2026-01-15 13:26:39*
